...
\geometry{left=1cm, top=1cm, right=1cm, bottom=1.6cm, footskip=.5cm}
...
\definecolor{awesome}{HTML}{320d8f}
...
\name{Chris}{Perceval-Maxwell {\small (he/him)}}
% \position{Computer Science{\enskip\bullet\enskip}Artificial Intelligence{\enskip\bullet\enskip}Full-Stack}
% \address{57/1 Newington Road, Edinburgh, EH9 1QW, SCOTLAND}

\mobile{(+44) 07378889025}
\email{chrispercevalmaxwell@gmail.com}
...
\lettertitle{Job Application for Graduate Web Developer}
% How the letter is opened
\letteropening{To whom it may concern,}
% How the letter is closed
\letterclosing{I look forward to hearing back.\\\\Sincerely,}
